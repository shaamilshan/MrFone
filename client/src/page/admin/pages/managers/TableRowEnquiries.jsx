...
const TableRowEnquiries = ({ index, length, product,attr,attrvalue }) => {
  ...
  return (
    <tr
      ...
      onClick={() => navigate(`edit/${product._id}/${product.enqattname}/${product.enqattvalue}`)}
    >
      ...
      <td className="admin-table-row">{product.enqattname}</td>
      <td className="admin-table-row">{product.enqattvalue}</td>
...
export default TableRowEnquiries;
